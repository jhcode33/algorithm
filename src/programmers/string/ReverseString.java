...
입출력 예 설명
입출력 예 #1
예제 1번의 my_string에서 인덱스 6부터 인덱스 12까지를 뒤집은 문자열은 "ProgrammerS123"이므로
"ProgrammerS123"를 return 합니다.

입출력 예 #2
예제 2번의 my_string에서 인덱스 4부터 인덱스 10까지를 뒤집으면 원래 문자열과 같은 "Stanley1yelnatS"이므로
...
public class ReverseString {
    public static String solution(String my_string, int s, int e) {
        ...
        sb.append(new StringBuilder().append(my_string, s, e + 1).reverse());
